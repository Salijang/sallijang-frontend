  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <div className="p-4 flex flex-col gap-6">
        ...
        <label className="relative w-full border-2 border-dashed border-gray-300 bg-gray-50 rounded-xl aspect-square flex flex-col items-center justify-center text-gray-400 gap-2 cursor-pointer hover:bg-gray-100 transition-colors overflow-hidden">
          {imagePreview ? (
            <>
