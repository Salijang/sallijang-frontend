...
export function HomePage({ onNavigate, onNavigateToCart, cartCount, now, isPcVersion, userId }: {
  ...
  const fetchProducts = React.useCallback((
    ...
    fetch(`https://api.sallijang.shop/api/v1/products/?${params.toString()}`)
      .then(res => res.json())
      .then(data => {
