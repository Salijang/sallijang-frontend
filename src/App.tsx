    ...
    return (
      <div className="bg-gray-50 min-h-screen text-gray-900 font-sans pb-20 relative">
        ...
        <main className={`max-w-[1200px] w-full mx-auto ${currentPage !== 'login' ? 'pt-24' : ''}`}>
           ...
           {currentPage === 'home' && <HomePage onNavigate={(p: number) => navigateTo('detail', p)} now={now} isPcVersion={isPcVersion} />}
           ...
           {['payment', 'complete', 'reservations', 'history', 'register', 'my', 'wishlist', 'sales', 'seller_home', 'reviews'].includes(currentPage) && (
